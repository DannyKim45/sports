...
import { myGameRecords } from "../data/myGames";
...
export default function MyGamesPage() {
  ...
  useEffect(() => {
    document.title = "나의 NHL 관람 기록 | Sports Athletes";
  }, []);
  ...
  return (
    <div className="page-container my-games-page">
      ...
      >
        <h1>나의 NHL 관람 기록</h1>
        <p className="page-subtitle">직접 경험한 NHL의 열정과 감동</p>
        <div className="games-stats">
          <div className="stat-badge">
            <span className="stat-number">{myGameRecords.length}</span>
      ...
      <div className="games-filter">
        ...
        <button
          className={`filter-btn ${filter === 'COL' ? 'active' : ''}`}
          onClick={() => setFilter('COL')}
        >
          Colorado
        </button>
        <button
          className={`filter-btn ${filter === 'CHI' ? 'active' : ''}`}
          onClick={() => setFilter('CHI')}
        >
          Chicago
        </button>
      </div>
              ...
              <div className="game-detail-content">
                ...
                <div className="game-detail-header">
                  ...
                  <div className="game-detail-matchup">
                    ...
                    <span className="vs-detail">VS</span>
                    <div className="team-detail">
                      <div>
